...
interface SoundscapeConfigProps {
  ...
  onBack: () => void;
  onStartExam: () => void;
  soundscapesEnabled?: boolean; // Nuevo: indica si el profesor habilitó soundscapes
}
...
export function SoundscapeConfig({ courseTitle, examType, onBack, onStartExam, soundscapesEnabled = true }: SoundscapeConfigProps) {
  ...
  // PANTALLA B: Cuando soundscapes está deshabilitado
      ...
      <div className="min-h-screen flex flex-col bg-[#ececec]">
        ...
        <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-8">
          ...
          >
            ...
            <h1 className="text-[#006d6f] mb-4" style={{ fontWeight: 700 }}>
            ...
            <div className="mb-6 flex items-center justify-center gap-2">
              <span style={{ fontWeight: 600, color: '#006d6f' }}>{courseTitle}</span>
            ...
            >
              ...
              <ul className="space-y-3 text-[#666666]">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#00bfbf]">✓</span>
                  <span>Recuerda guardar tus respuestas antes de finalizar</span>
                </li>
              </ul>
            </div>
            ...
            >
              <p className="text-[#006d6f]" style={{ fontWeight: 500 }}>
                🚀 ¡Tú puedes! Recuerda respirar profundo y mantener la calma.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={onStartExam}
                className="rounded-2xl border border-[#006d6f] bg-[#006d6f] px-8 py-4 text-white hover:bg-[#005555] transition-colors"
                style={{ 
                  fontWeight: 600,
  ...
  // PANTALLA A: Configuración completa de Soundscapes (código original)
  return (
    <div className="min-h-screen flex flex-col bg-[#ececec]">
      <div className="w-full h-1 bg-[#006d6f]"></div>
