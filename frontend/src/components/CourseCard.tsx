...
export function CourseCard({ title, code, imageUrl, onEnter, onMessage }: CourseCardProps) {
  return (
    <div 
      ...
      <div className="p-6 bg-white">
        ...
        <div className="flex gap-2">
          ...
          {onMessage && (
            <button
              onClick={onMessage}
              className="rounded-full p-2.5 border-2 border-[#00bfbf] bg-white hover:bg-[#00bfbf] hover:text-white transition-all duration-300 flex items-center justify-center"
